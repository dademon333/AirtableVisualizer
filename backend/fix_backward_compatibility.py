...
import traceback
import types
from asyncio import base_futures, format_helpers, constants, iscoroutine
from asyncio.log import logger
from typing import NoReturn


def fix_compatibility() -> NoReturn:
    """Fixes backwards compatibility for old packages, which are no longer
    supported.

    """
    # asynctest requires @asyncio.coroutine decorator,
    # which was removed in 3.11
    # The code above copied from asyncio 3.10
    asyncio.coroutine = coroutine
    asyncio.coroutines.CoroWrapper = CoroWrapper
